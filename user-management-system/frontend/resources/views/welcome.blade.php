    ...
    <div class="welcome-container">
        <div class="welcome-content">
            ...
            <p class="welcome-subtitle">
                A secure and modern platform for managing users with powerful administrative features.
            </p>
            ...
            <div class="feature-list">
                ...
                <div class="feature-item">
                    <span class="feature-icon"><i class="bi bi-check-circle-fill"></i></span>
                    <span>Advanced admin user management system</span>
                </div>
                <div class="feature-item">
                    <span class="feature-icon"><i class="bi bi-check-circle-fill"></i></span>
            ...
            <div class="welcome-buttons">
                @guest
                    <a href="{{ route('register') }}" class="btn-welcome btn-primary-welcome">
                        <i class="bi bi-person-plus"></i> Create Account
                    </a>
                    <a href="{{ route('login') }}" class="btn-welcome btn-secondary-welcome">
                ...
                @else
                    ...
                    <a href="{{ url('/profile') }}" class="btn-welcome btn-secondary-welcome">
            ...
            <div class="status-section">
                <p style="margin: 0; color: #4a5568; font-size: 0.95rem; margin-bottom: 1rem;">
                    <i class="bi bi-info-circle"></i> Backend API Status
                </p>
